...
// Overrides for CMD_PROP_RADIO_DIV_SETUP_PA FSK
...
// Overrides for CMD_PROP_RADIO_DIV_SETUP_PA FSK 200KBPS
...
// Overrides for CMD_PROP_RADIO_DIV_SETUP_PA SUB-1
uint32_t pOverridesTxStd_sub1[] =
{
...
// CMD_PROP_RADIO_DIV_SETUP_PA FSK
rfc_CMD_PROP_RADIO_DIV_SETUP_PA_t RF_cmdPropRadioDivSetup_fsk =
{
    .commandNo = 0x3807,
    .status = 0x0000,
    ...
    .intFreq = 0x8000,
    .loDivider = 0x05,
    .pRegOverrideTxStd = pOverridesTxStd_sub1,
    .pRegOverrideTx20 = pOverridesTx20_sub1,
};

// CMD_PROP_RADIO_DIV_SETUP_PA SIMPLELING LONGRANGE
...
// CMD_PROP_RADIO_DIV_SETUP_PA FSK 200 KBPS
rfc_CMD_PROP_RADIO_DIV_SETUP_PA_t RF_cmdPropRadioDivSetup_fsk_200kbps =
{
    .commandNo = 0x3807,
    .status = 0x0000,
    .pNextOp = 0, // INSERT APPLICABLE POINTER: (uint8_t*)&xxx
