...
/*
 * Setup for STMicroelectronics STM32 Nucleo144-F439ZI board.
 */
...
#define GPIOD_STLK_TX               8U
#define GPIOD_USART3_RX             9U
#define GPIOD_STLK_RX               9U
...
#define LINE_STLK_TX                PAL_LINE(GPIOD, 8U)
#define LINE_USART3_RX              PAL_LINE(GPIOD, 9U)
#define LINE_STLK_RX                PAL_LINE(GPIOD, 9U)
 ...
 * PB3  - ZIO_D23 I2S3_CK SWO       (alternate).
 ...
 * PD8  - USART3_TX STLK_TX         (alternate 7).
 * PD9  - USART3_RX STLK_RX         (alternate 7).
