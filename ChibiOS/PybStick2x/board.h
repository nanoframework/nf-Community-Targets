 ...
 * for various firmware, board layout and schematic.
   this source is based on Electron "Ineguinity Micro"
 */
...
/*
 * Setup for the PybStick board based upon an STM32F411RE.
 */
...
#define GPIOB_LED_YELLOW            0U
#define GPIOB_LED_BLUE              1U
...
#define GPIOB_FAKE_SD_DETECT        14U
#define GPIOB_SD_CK                 15U
...
#define LINE_FAKE_SD_DETECT         PAL_LINE(GPIOB, 14U)

#define LINE_GPIOA_UART1_RX         PAL_LINE(GPIOA, 10U)
#define LINE_GPIOA_UART1_TX         PAL_LINE(GPIOA, 15U)
...
#define LINE_I2C2_SDA              	PAL_LINE(GPIOB, 3U)
 ...
 * GPIOA setup:
 *
 * PA0  - ADC1_0                    (input analog).
 * PA1  - PIN1                      (input pullup).
 * PA2  - ADC1_2                    (input analog).
 * PA3  - ADC1_3                    (input analog).
 * PA4  - PIN4                      (input pullup).
 * PA5  - SPI1_CLK                  (alternate 5).
 * PA6  - SD_CMD                    (alternate 12).
 * PA7  - SPI1_MOSI                 (alternate 5).
 * PA8  - SD_D1                     (alternate 12).
 * PA9  - SD_D2                     (alternate 12).
 * PA10 - UART1_RX                  (alternate 7).
 * PA11 - OTG_FS_DM                 (alternate 10).
 * PA12 - OTG_FS_DP                 (alternate 10).
 * PA13 - LED_RED                   (output pushpull high).
 * PA14 - LED_GREEN                 (output pushpull high).
 * PA15 - UART1_TX                  (alternate 7).
 */
#define VAL_GPIOA_MODER             (PIN_MODE_ANALOG(GPIOA_ADC1_0) |           \
                                     PIN_MODE_INPUT(GPIOA_PIN1) |           \
                                     PIN_MODE_ANALOG(GPIOA_ADC1_2) |   \
                                     PIN_MODE_ANALOG(GPIOA_ADC1_3) |   \
                                     PIN_MODE_INPUT(GPIOA_PIN4) |           \
                                     PIN_MODE_ALTERNATE(GPIOA_SPI1_CLK) |     \
                                     PIN_MODE_ALTERNATE(GPIOA_SD_CMD) |           \
                                     PIN_MODE_ALTERNATE(GPIOA_SPI1_MOSI) |           \
                                     PIN_MODE_ALTERNATE(GPIOA_SD_D1) |           \
                                     PIN_MODE_ALTERNATE(GPIOA_SD_D2) |           \
...
#define VAL_GPIOA_OTYPER            (PIN_OTYPE_PUSHPULL(GPIOA_ADC1_0) |       \
                                     PIN_OTYPE_PUSHPULL(GPIOA_PIN1) |       \
                                     PIN_OTYPE_PUSHPULL(GPIOA_ADC1_2) |   \
                                     PIN_OTYPE_PUSHPULL(GPIOA_ADC1_3) |   \
                                     PIN_OTYPE_PUSHPULL(GPIOA_PIN4) |       \
                                     PIN_OTYPE_PUSHPULL(GPIOA_SPI1_CLK) |  \
                                     PIN_OTYPE_PUSHPULL(GPIOA_SD_CMD) |       \
                                     PIN_OTYPE_PUSHPULL(GPIOA_SPI1_MOSI) |       \
                                     PIN_OTYPE_PUSHPULL(GPIOA_SD_D1) |       \
                                     PIN_OTYPE_PUSHPULL(GPIOA_SD_D2) |       \
...
#define VAL_GPIOA_OSPEEDR           (PIN_OSPEED_HIGH(GPIOA_ADC1_0) |          \
                                     PIN_OSPEED_HIGH(GPIOA_PIN1) |          \
                                     PIN_OSPEED_HIGH(GPIOA_ADC1_2) |    \
                                     PIN_OSPEED_HIGH(GPIOA_ADC1_3) |    \
                                     PIN_OSPEED_HIGH(GPIOA_PIN4) |          \
                                     PIN_OSPEED_HIGH(GPIOA_SPI1_CLK) |   \
                                     PIN_OSPEED_HIGH(GPIOA_SD_CMD) |          \
                                     PIN_OSPEED_HIGH(GPIOA_SPI1_MOSI) |          \
                                     PIN_OSPEED_HIGH(GPIOA_SD_D1) |          \
                                     PIN_OSPEED_HIGH(GPIOA_SD_D2) |          \
                                     PIN_OSPEED_HIGH(GPIOA_UART1_RX) |         \
                                     PIN_OSPEED_HIGH(GPIOA_OTG_FS_DM) |     \
                                     PIN_OSPEED_HIGH(GPIOA_OTG_FS_DP) |     \
                                     PIN_OSPEED_MEDIUM(GPIOA_LED_RED) |         \
                                     PIN_OSPEED_MEDIUM(GPIOA_LED_GREEN) |         \
                                     PIN_OSPEED_HIGH(GPIOA_UART1_TX))
#define VAL_GPIOA_PUPDR             (PIN_PUPDR_FLOATING(GPIOA_ADC1_0) |         \
                                     PIN_PUPDR_PULLUP(GPIOA_PIN1) |         \
                                     PIN_PUPDR_FLOATING(GPIOA_ADC1_2) |   \
                                     PIN_PUPDR_FLOATING(GPIOA_ADC1_3) |   \
                                     PIN_PUPDR_FLOATING(GPIOA_PIN4) |         \
                                     PIN_PUPDR_FLOATING(GPIOA_SPI1_CLK) |  \
                                     PIN_PUPDR_FLOATING(GPIOA_SD_CMD) |         \
                                     PIN_PUPDR_FLOATING(GPIOA_SPI1_MOSI) |         \
                                     PIN_PUPDR_FLOATING(GPIOA_SD_D1) |         \
                                     PIN_PUPDR_FLOATING(GPIOA_SD_D2) |         \
...
#define VAL_GPIOA_ODR               (PIN_ODR_LOW(GPIOA_ADC1_0) |             \
                                     PIN_ODR_LOW(GPIOA_PIN1) |             \
                                     PIN_ODR_LOW(GPIOA_ADC1_2) |         \
                                     PIN_ODR_LOW(GPIOA_ADC1_3) |         \
                                     PIN_ODR_LOW(GPIOA_PIN4) |             \
                                     PIN_ODR_LOW(GPIOA_SPI1_CLK) |         \
                                     PIN_ODR_LOW(GPIOA_SD_CMD) |             \
                                     PIN_ODR_LOW(GPIOA_SPI1_MOSI) |             \
                                     PIN_ODR_LOW(GPIOA_SD_D1) |             \
                                     PIN_ODR_LOW(GPIOA_SD_D2) |             \
...
#define VAL_GPIOA_AFRL              (PIN_AFIO_AF(GPIOA_ADC1_0, 0U) |          \
                                     PIN_AFIO_AF(GPIOA_PIN1, 0U) |          \
                                     PIN_AFIO_AF(GPIOA_ADC1_2, 0U) |      \
                                     PIN_AFIO_AF(GPIOA_ADC1_3, 0U) |      \
                                     PIN_AFIO_AF(GPIOA_PIN4, 0U) |          \
                                     PIN_AFIO_AF(GPIOA_SPI1_CLK, 5U) |     \
                                     PIN_AFIO_AF(GPIOA_SD_CMD, 12U) |          \
                                     PIN_AFIO_AF(GPIOA_SPI1_MOSI, 5U))
#define VAL_GPIOA_AFRH              (PIN_AFIO_AF(GPIOA_SD_D1, 12U) |          \
                                     PIN_AFIO_AF(GPIOA_SD_D2, 12U) |          \
 ...
 * GPIOB setup:
 *
 * PB0  - LED_YELLOW                (output pushpull high).
 * PB1  - LED_BLUE                  (output pushpull high).
 * PB2  - PIN2                      (input pullup).
 * PB3  - I2C2_SDA                  (alternate 9).
 * PB4  - SPI1_MISO                 (alternate 5).
 * PB5  - SD_D3                     (alternate 12).
 * PB6  - PIN6                      (input pullup).
 * PB7  - SD_D0                     (alternate 12).
 * PB8  - I2C1_SCL                  (alternate 4).
 * PB9  - I2C1_SDA                  (alternate 4).
 * PB10 - I2C2_SCL                  (alternate 9).
...
#define VAL_GPIOB_MODER             (PIN_MODE_OUTPUT(GPIOB_LED_YELLOW) |           \
                                     ...
                                     PIN_MODE_ALTERNATE(GPIOB_SD_D0) |           \
                                     ...
                                     PIN_MODE_INPUT(GPIOB_FAKE_SD_DETECT) |          \
                                     PIN_MODE_ALTERNATE(GPIOB_SD_CK))
#define VAL_GPIOB_OTYPER            (PIN_OTYPE_PUSHPULL(GPIOB_LED_YELLOW) |       \
                                     ...
                                     PIN_OTYPE_PUSHPULL(GPIOB_SD_D0) |       \
                                     ...
                                     PIN_OTYPE_PUSHPULL(GPIOB_FAKE_SD_DETECT) |      \
                                     PIN_OTYPE_PUSHPULL(GPIOB_SD_CK))
#define VAL_GPIOB_OSPEEDR           (PIN_OSPEED_MEDIUM(GPIOB_LED_YELLOW) |          \
                                     PIN_OSPEED_MEDIUM(GPIOB_LED_BLUE) |          \
                                     PIN_OSPEED_HIGH(GPIOB_PIN2) |          \
                                     PIN_OSPEED_HIGH(GPIOB_I2C2_SDA) |           \
                                     PIN_OSPEED_HIGH(GPIOB_SPI1_MISO) |          \
                                     PIN_OSPEED_HIGH(GPIOB_SD_D3) |          \
                                     PIN_OSPEED_HIGH(GPIOB_PIN6) |          \
                                     PIN_OSPEED_HIGH(GPIOB_SD_D0) |          \
                                     ...
                                     PIN_OSPEED_HIGH(GPIOB_FAKE_SD_DETECT) |         \
                                     PIN_OSPEED_HIGH(GPIOB_SD_CK))
#define VAL_GPIOB_PUPDR             (PIN_PUPDR_FLOATING(GPIOB_LED_YELLOW) |         \
                                     ...
                                     PIN_PUPDR_FLOATING(GPIOB_SD_D0) |         \
                                     ...
                                     PIN_PUPDR_PULLUP(GPIOB_FAKE_SD_DETECT) |        \
                                     PIN_PUPDR_FLOATING(GPIOB_SD_CK))
#define VAL_GPIOB_ODR               (PIN_ODR_LOW(GPIOB_LED_YELLOW) |             \
                                     PIN_ODR_LOW(GPIOB_LED_BLUE) |             \
                                     PIN_ODR_HIGH(GPIOB_PIN2) |             \
                                     PIN_ODR_LOW(GPIOB_I2C2_SDA) |              \
                                     PIN_ODR_LOW(GPIOB_SPI1_MISO) |             \
                                     PIN_ODR_LOW(GPIOB_SD_D3) |             \
                                     PIN_ODR_HIGH(GPIOB_PIN6) |             \
                                     PIN_ODR_LOW(GPIOB_SD_D0) |             \
                                     ...
                                     PIN_ODR_HIGH(GPIOB_FAKE_SD_DETECT) |            \
                                     PIN_ODR_LOW(GPIOB_SD_CK))
#define VAL_GPIOB_AFRL              (PIN_AFIO_AF(GPIOB_LED_YELLOW, 0U) |          \
                                     PIN_AFIO_AF(GPIOB_LED_BLUE, 0U) |          \
                                     PIN_AFIO_AF(GPIOB_PIN2, 0U) |          \
                                     PIN_AFIO_AF(GPIOB_I2C2_SDA, 9U) |           \
                                     PIN_AFIO_AF(GPIOB_SPI1_MISO, 5U) |          \
                                     PIN_AFIO_AF(GPIOB_SD_D3, 12U) |          \
                                     PIN_AFIO_AF(GPIOB_PIN6, 0U) |          \
                                     PIN_AFIO_AF(GPIOB_SD_D0, 12U))
#define VAL_GPIOB_AFRH              (PIN_AFIO_AF(GPIOB_I2C1_SCL, 4U) |          \
                                     PIN_AFIO_AF(GPIOB_I2C1_SDA, 4U) |          \
                                     PIN_AFIO_AF(GPIOB_I2C2_SCL, 9U) |         \
                                     PIN_AFIO_AF(GPIOB_PIN11, 0U) |         \
                                     PIN_AFIO_AF(GPIOB_PIN12, 0U) |         \
                                     PIN_AFIO_AF(GPIOB_PIN13, 0U) |         \
                                     PIN_AFIO_AF(GPIOB_FAKE_SD_DETECT, 0U) |         \
                                     PIN_AFIO_AF(GPIOB_SD_CK, 12U))
...
#define VAL_GPIOC_PUPDR             (PIN_PUPDR_PULLUP(GPIOC_PIN0) |         \
                                     ...
                                     PIN_PUPDR_PULLUP(GPIOC_BUTTON_USER) |     \
