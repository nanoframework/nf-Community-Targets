...
#define LINE_USER_LED               PAL_LINE(GPIOA, 13U)
 ...
 * GPIOA setup:
 *
 * PA0  - USART2_CTS                (alternate 7).
 * PA1  - USART2_RTS                (alternate 7).
 * PA2  - USART2_TX                 (alternate 7).
 * PA3  - USART2_RX                 (alternate 7).
 * PA4  - ADC1_IN4                  (input pullup).
 ...
 * PA13 - USER_LED                  (output pushpull high).
...
#define VAL_GPIOA_OSPEEDR           (PIN_OSPEED_HIGH(GPIOA_USART2_CTS) |        \
                                     PIN_OSPEED_HIGH(GPIOA_USART2_RTS) |        \
                                     ...
                                     PIN_OSPEED_HIGH(GPIOA_USER_LED) |         \
...
#define VAL_GPIOA_ODR               (PIN_ODR_LOW(GPIOA_USART2_CTS) |           \
                                     PIN_ODR_LOW(GPIOA_USART2_RTS) |           \
                                     PIN_ODR_LOW(GPIOA_USART2_TX) |           \
                                     PIN_ODR_LOW(GPIOA_USART2_RX) |           \
                                     PIN_ODR_LOW(GPIOA_ADC1_IN4) |           \
                                     PIN_ODR_LOW(GPIOA_SPI1_SCLK) |         \
                                     ...
                                     PIN_ODR_LOW(GPIOA_USER_LED) |            \
                                     PIN_ODR_HIGH(GPIOA_PIN14) |            \
                                     PIN_ODR_HIGH(GPIOA_PIN15))
#define VAL_GPIOA_AFRL              (PIN_AFIO_AF(GPIOA_USART2_CTS, 7U) |        \
                                     PIN_AFIO_AF(GPIOA_USART2_RTS, 7U) |        \
...
#define VAL_GPIOB_OSPEEDR           (PIN_OSPEED_HIGH(GPIOB_PIN0) |        \
                                     ...
                                     PIN_OSPEED_HIGH(GPIOB_SPI2_SCLK) |         \
