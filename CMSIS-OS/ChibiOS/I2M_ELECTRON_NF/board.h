...
/*
 * Setup for the IngenuityMicro Electron board based upon an STM32F411CEU6.
 */

/*
 * Board identifier.
 */
#define BOARD_I2M_ELECTRON_NF
#define BOARD_NAME                  "IngenuityMicro Electron"
...
#define LINE_LED_BLUE               PAL_LINE(GPIOA, 8U)
