 ...
 * 
 * This is the standard NUCLEO-F411RE board but with the ST-LINK 
 * part cut-off. As a concequence there is no HSE anymore. 
 * For an HSE to work additional components have to be added X-Tal, 
 * a view caps and a view 0R resistors have to be made/removed.
 * This can all be read in OSC Clock chapter on page 24 of the 
 * UM1724 User manual of the NUCLEO-64 Board
 */
 ...
 * Board identifier.
 */
#define BOARD_ST_NUCLEO_F411RE_EX
#define BOARD_NAME                  "STMicroelectronics NUCLEO-F411RE-EX"
