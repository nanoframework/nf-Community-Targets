...
/*
 * Setup for STMicroelectronics STM32F411E-DISCOVERY board.
 */
...
#define BOARD_NAME                  "STMicroelectronics STM32F411VE Discovery for nanoFramework"
...
#define GPIOB_ADC1_CH8              0U
#define GPIOB_ADC1_CH9              1U
...
#define GPIOC_ADC1_CH11             1U
#define GPIOC_ADC1_CH12             2U
#define GPIOC_PDM_OUT               3U
#define GPIOC_PIN4                  4U
#define GPIOC_PIN5                  5U
#define GPIOC_PIN6                  6U
#define GPIOC_I2S3_MCLK             7U
#define GPIOC_PIN8                  8U
#define GPIOC_I2C3_SDA              9U
#define GPIOC_I2S3_SCLK             10U
#define GPIOC_PIN11                 11U
#define GPIOC_I2S3_SDIN             12U
...
#define GPIOD_LD4_GREEN             12U
#define GPIOD_LD3_ORANGE            13U
#define GPIOD_LD5_RED               14U
#define GPIOD_LD6_BLUE              15U

#define GPIOE_L3GD20_INT1           0U
#define GPIOE_L3GD20_INT2           1U
#define GPIOE_DLHC_DRDY             2U
#define GPIOE_L3GD20_CS_SPI         3U
#define GPIOE_DLHC_INT1             4U
#define GPIOE_DLHC_INT2             5U
...
#define LINE_ADC1_CH1               PAL_LINE(GPIOA, 1U)
...
#define LINE_ADC1_CH8               PAL_LINE(GPIOB, 0U)
#define LINE_ADC1_CH9               PAL_LINE(GPIOB, 1U)
...
#define LINE_ADC1_CH11              PAL_LINE(GPIOC, 1U)
#define LINE_ADC1_CH12              PAL_LINE(GPIOC, 2U)
#define LINE_PDM_OUT                PAL_LINE(GPIOC, 3U)
#define LINE_I2S3_MCLK              PAL_LINE(GPIOC, 7U)
#define LINE_I2C3_SDA               PAL_LINE(GPIOC, 9U)
#define LINE_I2S3_SCLK              PAL_LINE(GPIOC, 10U)
#define LINE_I2S3_SDIN              PAL_LINE(GPIOC, 12U)
#define LINE_OSC32_IN               PAL_LINE(GPIOC, 14U)
#define LINE_OSC32_OUT              PAL_LINE(GPIOC, 15U)

#define LINE_RESET                  PAL_LINE(GPIOD, 4U)
#define LINE_OTG_FS_OC              PAL_LINE(GPIOD, 5U)
#define LINE_LD4_GREEN              PAL_LINE(GPIOD, 12U)
#define LINE_LD3_ORANGE             PAL_LINE(GPIOD, 13U)
#define LINE_LD5_RED                PAL_LINE(GPIOD, 14U)
#define LINE_LD6_BLUE               PAL_LINE(GPIOD, 15U)

#define LINE_L3GD20_INT1            PAL_LINE(GPIOE, 0U)
#define LINE_L3GD20_INT2            PAL_LINE(GPIOE, 1U)
#define LINE_DLHC_DRDY              PAL_LINE(GPIOE, 2U)
#define LINE_L3GD20_CS_SPI          PAL_LINE(GPIOE, 3U)
#define LINE_DLHC_INT1              PAL_LINE(GPIOE, 4U)
#define LINE_DLHC_INT2              PAL_LINE(GPIOE, 5U)
...
#define VAL_GPIOA_MODER             (PIN_MODE_INPUT(GPIOA_BUTTON) |         \
                                     PIN_MODE_ANALOG(GPIOA_ADC1_CH1) |         \
...
#define VAL_GPIOA_OTYPER            (PIN_OTYPE_PUSHPULL(GPIOA_BUTTON) |     \
                                     PIN_OTYPE_PUSHPULL(GPIOA_ADC1_CH1) |     \
...
#define VAL_GPIOA_OSPEEDR           (PIN_OSPEED_VERYLOW(GPIOA_BUTTON) |        \
                                     PIN_OSPEED_HIGH(GPIOA_ADC1_CH1) |        \
...
#define VAL_GPIOA_PUPDR             (PIN_PUPDR_FLOATING(GPIOA_BUTTON) |       \
                                     PIN_PUPDR_FLOATING(GPIOA_ADC1_CH1) |       \
 ...
 */
#define VAL_GPIOB_MODER             (PIN_MODE_ANALOG(GPIOB_ADC1_CH8) |         \
                                     PIN_MODE_ANALOG(GPIOB_ADC1_CH9) |           \
...
#define VAL_GPIOB_OTYPER            (PIN_OTYPE_PUSHPULL(GPIOB_ADC1_CH8) |     \
                                     PIN_OTYPE_PUSHPULL(GPIOB_ADC1_CH9) |       \
...
#define VAL_GPIOB_OSPEEDR           (PIN_OSPEED_HIGH(GPIOB_ADC1_CH8) |        \
                                     PIN_OSPEED_HIGH(GPIOB_ADC1_CH9) |          \
...
#define VAL_GPIOB_PUPDR             (PIN_PUPDR_FLOATING(GPIOB_ADC1_CH8) |       \
                                     PIN_PUPDR_FLOATING(GPIOB_ADC1_CH9) |         \
...
#define VAL_GPIOB_ODR               (PIN_ODR_LOW(GPIOB_ADC1_CH8) |           \
                                     PIN_ODR_LOW(GPIOB_ADC1_CH9) |             \
...
#define VAL_GPIOB_AFRL              (PIN_AFIO_AF(GPIOB_ADC1_CH8, 0U) |        \
                                     PIN_AFIO_AF(GPIOB_ADC1_CH9, 0U) |          \
 ...
 * PD12 - LD4_GREEN                 (output pushpull maximum).
 * PD13 - LD3_ORANGE                (output pushpull maximum).
 * PD14 - LD5_RED                   (output pushpull maximum).
 * PD15 - LD6_BLUE                  (output pushpull maximum).
 */
#define VAL_GPIOD_MODER             (PIN_MODE_INPUT(GPIOD_PIN0) |           \
                                     ...
                                     PIN_MODE_INPUT(GPIOD_OTG_FS_OC) |           \
                                     ...
                                     PIN_MODE_OUTPUT(GPIOD_LD4_GREEN) |          \
                                     PIN_MODE_OUTPUT(GPIOD_LD3_ORANGE) |          \
                                     PIN_MODE_OUTPUT(GPIOD_LD5_RED) |          \
                                     PIN_MODE_OUTPUT(GPIOD_LD6_BLUE))
#define VAL_GPIOD_OTYPER            (PIN_OTYPE_PUSHPULL(GPIOD_PIN0) |       \
                                     PIN_OTYPE_PUSHPULL(GPIOD_PIN1) |       \
                                     PIN_OTYPE_PUSHPULL(GPIOD_PIN2) |       \
                                     PIN_OTYPE_PUSHPULL(GPIOD_PIN3) |       \
                                     PIN_OTYPE_PUSHPULL(GPIOD_RESET) |       \
                                     PIN_OTYPE_PUSHPULL(GPIOD_OTG_FS_OC) |       \
                                     ...
                                     PIN_OTYPE_PUSHPULL(GPIOD_LD4_GREEN) |      \
                                     PIN_OTYPE_PUSHPULL(GPIOD_LD3_ORANGE) |      \
                                     PIN_OTYPE_PUSHPULL(GPIOD_LD5_RED) |      \
                                     PIN_OTYPE_PUSHPULL(GPIOD_LD6_BLUE))
#define VAL_GPIOD_OSPEEDR           (PIN_OSPEED_HIGH(GPIOD_PIN0) |          \
                                     PIN_OSPEED_HIGH(GPIOD_PIN1) |          \
                                     PIN_OSPEED_HIGH(GPIOD_PIN2) |          \
                                     PIN_OSPEED_HIGH(GPIOD_PIN3) |          \
                                     PIN_OSPEED_HIGH(GPIOD_RESET) |          \
                                     PIN_OSPEED_HIGH(GPIOD_OTG_FS_OC) |          \
                                     ...
                                     PIN_OSPEED_HIGH(GPIOD_LD4_GREEN) |         \
                                     PIN_OSPEED_HIGH(GPIOD_LD3_ORANGE) |         \
                                     PIN_OSPEED_HIGH(GPIOD_LD5_RED) |         \
                                     PIN_OSPEED_HIGH(GPIOD_LD6_BLUE))
#define VAL_GPIOD_PUPDR             (PIN_PUPDR_PULLUP(GPIOD_PIN0) |         \
                                     PIN_PUPDR_PULLUP(GPIOD_PIN1) |         \
                                     PIN_PUPDR_PULLUP(GPIOD_PIN2) |         \
                                     PIN_PUPDR_PULLUP(GPIOD_PIN3) |         \
                                     PIN_PUPDR_FLOATING(GPIOD_RESET) |         \
                                     PIN_PUPDR_FLOATING(GPIOD_OTG_FS_OC) |         \
                                     ...
                                     PIN_PUPDR_FLOATING(GPIOD_LD4_GREEN) |        \
                                     PIN_PUPDR_FLOATING(GPIOD_LD3_ORANGE) |        \
                                     PIN_PUPDR_FLOATING(GPIOD_LD5_RED) |        \
                                     PIN_PUPDR_FLOATING(GPIOD_LD6_BLUE))
#define VAL_GPIOD_ODR               (PIN_ODR_HIGH(GPIOD_PIN0) |             \
                                     PIN_ODR_HIGH(GPIOD_PIN1) |             \
                                     PIN_ODR_HIGH(GPIOD_PIN2) |             \
                                     PIN_ODR_HIGH(GPIOD_PIN3) |             \
                                     PIN_ODR_HIGH(GPIOD_RESET) |             \
                                     PIN_ODR_HIGH(GPIOD_OTG_FS_OC) |             \
                                     ...
                                     PIN_ODR_LOW(GPIOD_LD4_GREEN) |            \
                                     PIN_ODR_LOW(GPIOD_LD3_ORANGE) |            \
                                     PIN_ODR_LOW(GPIOD_LD5_RED) |            \
                                     PIN_ODR_LOW(GPIOD_LD6_BLUE))
#define VAL_GPIOD_AFRL              (PIN_AFIO_AF(GPIOD_PIN0, 0U) |          \
                                     PIN_AFIO_AF(GPIOD_PIN1, 0U) |          \
                                     PIN_AFIO_AF(GPIOD_PIN2, 0U) |          \
                                     PIN_AFIO_AF(GPIOD_PIN3, 0U) |          \
                                     PIN_AFIO_AF(GPIOD_RESET, 0U) |          \
                                     PIN_AFIO_AF(GPIOD_OTG_FS_OC, 0U) |          \
...
#define VAL_GPIOD_AFRH              (PIN_AFIO_AF(GPIOD_PIN8, 0U) |          \
                                     ...
                                     PIN_AFIO_AF(GPIOD_LD4_GREEN, 0U) |         \
                                     PIN_AFIO_AF(GPIOD_LD3_ORANGE, 0U) |         \
                                     PIN_AFIO_AF(GPIOD_LD5_RED, 0U) |         \
                                     PIN_AFIO_AF(GPIOD_LD6_BLUE, 0U))

/*
 * GPIOE setup:
 *
 * PE0  - L3GD20_INT1               (input floating).
 * PE1  - L3GD20_INT2               (input floating).
 * PE2  - DLHC_DRDY                 (input floating).
 * PE3  - L3GD20_CS_SPI             (output pushpull maximum).
 * PE4  - DLHC_INT1                 (input floating).
 * PE5  - DLHC_INT2                 (input floating).
...
#define VAL_GPIOE_MODER             (PIN_MODE_INPUT(GPIOE_L3GD20_INT1) |           \
                                     ...
                                     PIN_MODE_INPUT(GPIOE_DLHC_DRDY) |           \
                                     PIN_MODE_OUTPUT(GPIOE_L3GD20_CS_SPI) |           \
                                     PIN_MODE_INPUT(GPIOE_DLHC_INT1) |           \
                                     PIN_MODE_INPUT(GPIOE_DLHC_INT2) |           \
...
#define VAL_GPIOE_OTYPER            (PIN_OTYPE_PUSHPULL(GPIOE_L3GD20_INT1) |       \
                                     ...
                                     PIN_OTYPE_PUSHPULL(GPIOE_DLHC_DRDY) |       \
                                     PIN_OTYPE_PUSHPULL(GPIOE_L3GD20_CS_SPI) |       \
                                     PIN_OTYPE_PUSHPULL(GPIOE_DLHC_INT1) |       \
                                     PIN_OTYPE_PUSHPULL(GPIOE_DLHC_INT2) |       \
...
#define VAL_GPIOE_OSPEEDR           (PIN_OSPEED_HIGH(GPIOE_L3GD20_INT1) |          \
                                     ...
                                     PIN_OSPEED_HIGH(GPIOE_DLHC_DRDY) |          \
                                     PIN_OSPEED_HIGH(GPIOE_L3GD20_CS_SPI) |          \
                                     PIN_OSPEED_HIGH(GPIOE_DLHC_INT1) |          \
                                     PIN_OSPEED_HIGH(GPIOE_DLHC_INT2) |          \
...
#define VAL_GPIOE_PUPDR             (PIN_PUPDR_FLOATING(GPIOE_L3GD20_INT1) |         \
                                     PIN_PUPDR_FLOATING(GPIOE_L3GD20_INT2) |         \
                                     PIN_PUPDR_FLOATING(GPIOE_DLHC_DRDY) |         \
                                     PIN_PUPDR_FLOATING(GPIOE_L3GD20_CS_SPI) |         \
                                     PIN_PUPDR_FLOATING(GPIOE_DLHC_INT1) |         \
                                     PIN_PUPDR_FLOATING(GPIOE_DLHC_INT2) |         \
...
#define VAL_GPIOE_ODR               (PIN_ODR_HIGH(GPIOE_L3GD20_INT1) |             \
                                     ...
                                     PIN_ODR_HIGH(GPIOE_DLHC_DRDY) |             \
                                     PIN_ODR_HIGH(GPIOE_L3GD20_CS_SPI) |             \
                                     PIN_ODR_HIGH(GPIOE_DLHC_INT1) |             \
                                     PIN_ODR_HIGH(GPIOE_DLHC_INT2) |             \
...
#define VAL_GPIOE_AFRL              (PIN_AFIO_AF(GPIOE_L3GD20_INT1, 0U) |          \
                                     ...
                                     PIN_AFIO_AF(GPIOE_DLHC_DRDY, 0U) |          \
                                     PIN_AFIO_AF(GPIOE_L3GD20_CS_SPI, 0U) |          \
                                     PIN_AFIO_AF(GPIOE_DLHC_INT1, 0U) |          \
                                     PIN_AFIO_AF(GPIOE_DLHC_INT2, 0U) |          \
